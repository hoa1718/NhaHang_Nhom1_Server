...
class thucDonController {
  ...
  async create(req, res, next) {
    try {
      ...
      console.log(item.CongThuc[1]);
      var query=""
      item.CongThuc.forEach((item)=>{
        "Insert into CongThuc(IDMon,IDNguyenLieu,GiaTien,IDPhanLoai,Image) values(@TenMon,@GiaBan,@GiaTien,@IDPhanLoai,@Image)"
      });
      // var request = new sql.Request();
      // request
