...
class thucDonController {
  ...
  async search(req, res, next) {
    try{
      ...
      var sql_query = "select IDMon,TenMon,GiaBan,TenPhanLoai,Image from MonAn,PhanLoai where MonAn.IDPhanLoai=PhanLoai.IDPhanLoai and ContainMonAn.TenMon Like %" + keyWord +"%";
