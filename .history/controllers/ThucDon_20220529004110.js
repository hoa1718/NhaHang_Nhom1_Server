...
class thucDonController {
  ...
  async detail(req, res, next) {
    ...
    var sql_query =
      ...
      id+"\n"+
      "select TenNguyenLieu,SoLuong,DonViTinh from CongThuc,NguyenLieu,DonViTinh where CongThuc.IDMon= "+ id +"and CongThuc.IDNguyenLieu= NguyenLieu.IDNguyenLieu and "
      +"\n"+
