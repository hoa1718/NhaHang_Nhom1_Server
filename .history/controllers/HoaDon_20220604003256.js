    ...
    async create(req,res,next){
      try {
        ...
        request
          ...
          .input("IDPhuongThuc", sql.Int, item.IDPhuongThuc)
          .input("NgayLap", sql.DateTime, item.NgayLap);
        var sql_query =
          "Insert into HoaDon(IDBan,IDKhachHang,TrangThai,IDPhuongThuc,NgayLap) values(@IDHoaDon,@IDBan,@IDKhachHang,@TrangThai,@IDPhuongThuc,@NgayLap)\n";
