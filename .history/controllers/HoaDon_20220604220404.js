...
class hoaDonController {
    ...
    async create(req,res,next){
      try {
        ...
        var congThucQuery="select NguyenLieu.IDNguyenLieu, NguyenLieu.SoLuongTon, CongThuc.SoLuong From NguyenLieu,CongThuc where CongThuc.IDNguyenLieu = NguyenLieu.IDNguyenLieu  CongThuc.IDMon=20  ";
