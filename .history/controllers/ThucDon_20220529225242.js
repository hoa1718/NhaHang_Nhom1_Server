...
class thucDonController {
  ...
  async detail(req, res, next) {
    ...
    var sql_query =
      "select IDMon,TenMon,GiaBan,GiaTien,IDPhanLoai,TenPhanLoai,Image from MonAn,PhanLoai where MonAn.IDPhanLoai=PhanLoai.IDPhanLoai and MonAn.IDMon =" +
      id+"\n"+
      "select TenNguyenLieu,SoLuong,DonViTinh from CongThuc,NguyenLieu,DonViTinh where CongThuc.IDMon= "+ id +"and CongThuc.IDNguyenLieu= NguyenLieu.IDNguyenLieu and NguyenLieu.IDDVT=DonViTinh.IDDVT "
      +"\n"+
