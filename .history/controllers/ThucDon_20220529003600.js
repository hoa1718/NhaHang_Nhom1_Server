...
class thucDonController {
  ...
  async detail(req, res, next) {
    ...
    var sql_query =
      "select IDMon,TenMon,GiaBan,GiaTien,TenPhanLoai,Image,DVT from MonAn,PhanLoai,DonViTinh where MonAn.IDPhanLoai=PhanLoai.IDPhanLoai and MonAn.IDMon =" +
      id+"\n"+
      "select TenNguyenLieu,SoLuong from CongThuc,NguyenLieu where CongThuc.IDMon= "+ id +"and CongThuc.IDNguyenLieu= NguyenLieu.IDNguyenLieu"
      +"\n"+
